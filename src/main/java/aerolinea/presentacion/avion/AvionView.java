...
public class AvionView extends javax.swing.JPanel implements Observer {
    ...
    AvionController controller;
    AvionModel model;
    VentanaPrincipalView main;
    public JDialog dialogo;
     
    public AvionView(VentanaPrincipalView main) {
        initComponents();
        this.main = main;
        principaltable.setModel(new TableModelAvion(Modelo.getInstance().GetAllAviones()));
    ...
    private void initComponents() {
        ...
        labeltittle.setText("Administrar aviones");
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        Avion temp = model.tabletipo.getElement(principaltable.convertRowIndexToModel(principaltable.getSelectedRow()));
            try {
...
//            Logger.getLogger(AvionView.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public AvionController getController() {
        return controller;
    }

    public AvionModel getModel() {
        return model;
    }
    ...
    public void setModel(AvionModel model) {
        this.model = model;
