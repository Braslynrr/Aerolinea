...
public class PagoView extends javax.swing.JPanel implements Observer {
    ...
    public PagoView(VentanaPrincipalView main) {
        initComponents();
        this.main = main;
        principaltable.setModel(new TableModelPago(Modelo.getInstance().GetAllMetodos()));
    ...
    private void initComponents() {
        ...
        labeltittle.setText("Administrar tipos de pago");
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        MetodoPago temp = model.tabletipo.getElement(principaltable.convertRowIndexToModel(principaltable.getSelectedRow()));
            try {
...
//            JOptionPane.showMessageDialog(null, "ERROR: Alguna entidad necesita de este metodo de pago, no se puede eliminar aun.");
    ...
    public PagoController getController() {
        return controller;
    }
    ...
    public void setController(PagoController controller) {
        this.controller = controller;
    }

    public void setModel(PagoModel model) {
        this.model = model;
