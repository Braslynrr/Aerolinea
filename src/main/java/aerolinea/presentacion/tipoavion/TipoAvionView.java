...
public class TipoAvionView extends javax.swing.JPanel implements Observer {
    ...
    public TipoAvionView(VentanaPrincipalView main) {
        initComponents();
        this.main = main;
        principaltable.setModel(new TableModelTipoAvion(Modelo.getInstance().GetAll()));
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        TipoAvion temp = model.tabletipo.getElement(principaltable.convertRowIndexToModel(principaltable.getSelectedRow()));
            try {
