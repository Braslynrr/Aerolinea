...
public class CiudadView extends javax.swing.JPanel implements Observer {
    ...
    public CiudadView(VentanaPrincipalView main) {
        initComponents();
        this.main = main;
        principaltable.setModel(new TableModelCiudad(Modelo.getInstance().GetAllCiudad()));
    ...
    private void initComponents() {
        ...
        labeltittle.setText("Administrar ciudades");
    ...
    private void añadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_añadirActionPerformed
       ...
       dialogo = new JDialog(main,"Añadir avión",true);
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        Ciudad temp = model.tabletipo.getElement(principaltable.convertRowIndexToModel(principaltable.getSelectedRow()));
            try {
    ...
    public CiudadController getController() {
        return controller;
    }

    public CiudadModel getModel() {
        return model;
    }

    public void setController(CiudadController controller) {
        this.controller = controller;
    }

    public void setModel(CiudadModel model) {
        this.model = model;
