...
public class Modelo {
    ...
    public List<TipoAvion> Search(String search, int index) {
        switch (index) {
            ...
            case 1:
                return TipoAvionDao.getInstance().findByIdentifier(search);

            case 2:
                return TipoAvionDao.getInstance().findByAño(search);

            case 3:
                return TipoAvionDao.getInstance().findByModelo(search);

            case 4:
                return TipoAvionDao.getInstance().findByMarca(search);

            case 5:
                return TipoAvionDao.getInstance().findByAsientos(search);

            case 6:
                return TipoAvionDao.getInstance().findByFilas(search);
    ...
    public List<Avion> SearchAvion(String search, int index) {
        switch (index) {
            ...
            case 1:
                return AvionDao.getInstance().findByIdentifier(search);

            case 2:
                return AvionDao.getInstance().findByTipoAvion(search);

            case 3:
                return AvionDao.getInstance().findByModelo(search);

            case 4:
                return AvionDao.getInstance().findByAño(search);
        }
        return null;
    }
    ...
    public List<Pais> SearchPais(String search, int index) {
        switch (index) {
            ...
            case 1:
                return PaisDao.getInstance().findByCodigo(search);

            case 2:
                return PaisDao.getInstance().findByNombre(search);
    ...
    public List<Ciudad> SearchCiudad(String search, int index) {
        switch (index) {
            ...
            case 1:
                return CiudadDao.getInstance().findByCodigo(search);

            case 2:
                return CiudadDao.getInstance().findByNombre(search);

            case 3:
                return CiudadDao.getInstance().findByPais(search);
    ...
    public List<MetodoPago> SearchMetodo(String search, int index) {
        switch (index) {
            ...
            case 1:
                return MetodoPagoDao.getInstance().findByCodigo(search);

            case 2:
                return MetodoPagoDao.getInstance().findByDescripcion(search);
